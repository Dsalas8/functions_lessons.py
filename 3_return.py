# Return Practice #1
# Create a function called power that takes two numeric values as parameter. It must return the number that results from solving a power, using the first number as the base, and the second as the exponent
...
usd = 0.9
money = 5
def usd_to_eur(money,usd):
    return money * usd 

print(usd_to_eur(money,usd))
