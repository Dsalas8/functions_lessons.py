...
#def happy_birthday(name, age):                   #THIS IS A PARAMETER    
#    print(f"Happy birthday to {name}!")             #tHIS IS A VARIABLE
#    print("You are {age} years old")
#    print("Happy birthday to you!")
#    print()

#happy_birthday("Bro", 20)               #THIS IS A ARGUEMENT BECAUSE IT GIVES REAL DATA TO GO INTO THE PARAMETER #the  HAPPY BIRTHDAY IS A CALL FUNCTION.
...
#display_invoice("Goober", 67.67, "12/25")
#display_invoice("Chud", 50.00 "04,25")

    #RETURN STATEMENTS VERY IMPORTANT 
#----------------------------------------------------
#return = statement used to end a function 
#           and senda result back to the collar 
...
full_name = create_name("Spongbob", "Sqaurepants")
print(full_name)
